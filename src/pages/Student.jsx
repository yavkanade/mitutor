    ...
    <div className="student-container">
      <div>
        ...
        >
          ...
          <label>Courses:</label>
          <textarea
            value={addStudentCourses.join("\n")}
            onChange={handleAddStudentCourse}
          ></textarea>
          <br />
      ...
      <div>
        ...
        >
          ...
          <input
            ...
            onChange={(event) => setDeleteStudentName(event.target.value)}
          />
          <br />
          <label>Email:</label>
          <input
            type="text"
            value={deleteStudentEmail}
            onChange={(event) => setDeleteStudentEmail(event.target.value)}
          />
          <br />
